...
public class WordSorterFrontEnd {
	...
	// The file name to be read in the program's root directory. Be mindful that the
	// program's directory is often times not the source directory
	public static final String FILE_NAME = "C:\\Users\\cbier\\OneDrive\\USCSchool\\Spring 2024\\CSCE146Stuff\\Labs\\Lab01\\randomwords.txt";
