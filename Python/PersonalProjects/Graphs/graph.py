...
class LinkedDirectedGraph(AbstractCollection):
    ...
    def addVertex(self, label):
        ...
        if label in self.vertices:
            raise KeyError("Vertex Already In Graph")
        else:
    ...
    def addEdge(self, fromLabel, toLabel, weight):
        ...
        if fromLabel and toLabel and weight in self.vertices:
            raise KeyError("Edge Already Exists In Graph")
    ...
    def getEdge(self, fromLabel, toLabel):
        ...
        no edge exists."""
        if not fromLabel and toLabel in self.vertices:
            raise KeyError("Edge Does Not Exists In Graph")
        else:
            fromVertex = self.getVertex(fromLabel)
            toVertex   = self.getVertex(toLabel)
    ...
    def removeEdge(self, fromLabel, toLabel): 
        ...
        if not self.getEdge in self.vertices:
            raise KeyError("Edge Does Not Exists In Graph")
        fromVertex = self.getVertex(fromLabel)     
        toVertex   = self.getVertex(toLabel)     
