...
$(document).ready( () => {
    $( "#save" ).click( () => {
        ...
        if (isValid) { 
            ...
            let profileArray = [];
            profileArray.push(["Email", email]);
            profileArray.push(["Phone", phone]);
            profileArray.push(["ZIP", zip]);
            profileArray.push(["Date Of Birth", dob]);

            sessionStorage.profile = JSON.stringify(profileArray);
